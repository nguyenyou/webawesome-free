...
const avatarManifest = getManifest("Avatar");
...
const meta: Meta = {
  ...
  argTypes: {
    shape: {
      control: 'radio',
      options: getOptions('shape', avatarManifest),
    },
  },
} satisfies Meta;
...
export const Initials: Story = {
  render: () => html` <wa-avatar initials="WA" label="Avatar with initials: SL"></wa-avatar> `,
};
